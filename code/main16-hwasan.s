...
// %bb.0:
	...
	mov	w9, w8
	sturb	w9, [x29, #-1]
	bl	__hwasan_check_x1_18_short_v2
	ldr	x20, [sp, #16]                  // 8-byte Folded Reload
	mov	w9, #16
	str	w9, [x1]
	eor	x9, x8, #0x80
...
// %bb.0:
	...
	ret
.Lfunc_end12:
	.size	hwasan.module_ctor, .Lfunc_end12-hwasan.module_ctor
	.cfi_endproc
                                        // -- End function
...
.L.str.4.hwasan:
	.asciz	"%p %p\n"
	.ascii	"\000\000\000\000\000\000\000\000\031"
...
.Ltmp26:
	...
	ldr	x16, [x16, :got_lo12:__hwasan_tag_mismatch_v2]
	br	x16
	.section	.text.hot,"axG",@progbits,__hwasan_check_x1_18_short_v2,comdat
	.type	__hwasan_check_x1_18_short_v2,@function
	.weak	__hwasan_check_x1_18_short_v2
	.hidden	__hwasan_check_x1_18_short_v2
__hwasan_check_x1_18_short_v2:
	sbfx	x16, x1, #4, #52
	ldrb	w16, [x20, x16]
	cmp	x16, x1, lsr #56
	b.ne	.Ltmp27
